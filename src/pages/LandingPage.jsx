    ...
    <>
      ...
      <main>
        <section className="px-4 md:px-20 py-6 md:py-12 bg-neat-50 flex flex-col md:flex-row items-center justify-center">
          <h2 className="text-sm sm:mr-12 md:text-xl md:font-bold text-opacity-5">
            Dipercayai oleh:
          </h2>
        ...
        <section className="px-2 sm:px-12 py-4 md:py-12 flex flex-col items-center">
          ...
          <p className="text-center md:font-thin md:text-xl max-w-4xl leading-6">
            &quot;EcoSwap: Menghubungkan <strong>produsen</strong> dan{" "}
            <strong>pengelola</strong> sampah untuk memaksimalkan nilai sampah
            dengan teknologi&quot;
          </p>
        </section>
          ...
          <div className="w-full flex flex-col text-neutral-800">
            ...
            >
              {missions.map((mission) => (
                <li
                  key={mission}
                  className="flex gap-1 sm:gap-3 text-pretty md:text-lg"
                >
                  <img
                    loading="lazy"
                    width="1"
        ...
        <section className="flex flex-col self-stretch px-4 sm:px-12 py-4 sm:py-12">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-4">
            {testimonies.map((testimony, index) => (
              <div
                key={index}
                className="flex flex-col text-base leading-4 p-4 rounded-xl bg-neat-50 text-green-950"
              >
        ...
        <section className="px-4 sm:px-6 text-xl sm:text-2xl flex flex-col justify-center items-center min-h-min py-6 relative overflow-hidden  text-white">
          <div className="text-xl sm:text-2xl flex flex-col justify-center items-center">
            ...
            <div className="relative leading-6 sm:leading-8 text-center max-md:max-w-full italic">
              &quot;Ancaman terbesar bagi planet kita adalah?{" "}
              <span className="text-dark">
                keyakinan bahwa ada orang lain yang akan menyelamatkannya.&quot;
...
const poinPerans = [
  {
    title: "📈 Memanfaatkan Limbah Secara Maksimal",
    paragraf:
      "Memanfaatkan sampah bernilai tambah untuk kesejahteraan masyarakat",
  },
  {
    title: "📉 Mengurangi Limbah",
    paragraf:
      "Menyediakan fasilitas jual beli sampah antara produsen dan pengelola untuk penggunaan yang optimal",
  },
  {
    title: "👀 Bentuk Promosi Daur Ulang Sampah",
    paragraf:
      "Mendorong kesadaran akan daur ulang dan mendukung program lingkungan pemerintah melalui transaksi sampah",
  },
];
