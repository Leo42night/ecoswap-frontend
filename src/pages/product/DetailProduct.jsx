...
export default function DetailProduct() {
  ...
  // If currentUser is null or undefined, you can optionally return null or a loading state
  // if (!currentUser) {
  ...
  const product =
    productBySlug.find((product) => product.slug === slug)?.product || null;
  ...
  // id bisa digunakan untuk mengambil data dari API
